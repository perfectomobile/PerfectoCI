...
public abstract class BasicTest2 {
	...
	protected static final String PERFECTO_MOBILE_AUTOMATION_NAME = "PerfectoMobile";
	
	protected String automationName = PERFECTO_MOBILE_AUTOMATION_NAME;	
	...
	public void beforeClass(String testCycle) throws Exception{
		...
		//For Web test: deviceName = Chrome
		...
		//For Mobile test:
		this.driver = PerfectoUtils.getDriver(caps, this.driverRetries, retryIntervalSeconds, automationName);
	}
